 ...
 * 1. query your balance - the console will output your wallet's BNB balance and your target token's balance every 2 seconds
...
// amount of BNB you want to use to buy the target token per transaction, leave the '' around the amount (eg '10' not 10)
const BNB_AMOUNT_PER_TRANSACTION = '0.000001';
...
const TOKEN_AMOUNT_PER_TRANSACTION = '0.000001';
...
module.exports = {
    ...
    BNB_AMOUNT_PER_TRANSACTION: BNB_AMOUNT_PER_TRANSACTION,
