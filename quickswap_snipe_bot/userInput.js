 ...
 * 1. query your balance - the console will output your wallet's MATIC balance and your target token's balance every 2 seconds
...
const NUMBER_OF_BUY_TRANSACTIONS = 1;
// amount of MATIC you want to use to buy the target token per transaction, leave the '' around the amount (eg '10' not 10)
const MATIC_AMOUNT_PER_TRANSACTION = '0.000001';
...
module.exports = {
    ...
    MATIC_AMOUNT_PER_TRANSACTION: MATIC_AMOUNT_PER_TRANSACTION,
